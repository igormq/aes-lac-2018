...
class LapsBM(Corpus):
    ...
    DATASET_URLS = {
        "val":
        ["https://www.dropbox.com/s/c1cieo0u0earx69/lapsbm-val.tar.gz?dl=1"],
        "test":
        ["https://www.dropbox.com/s/ssbjagkynylldvd/lapsbm-test.tar.gz?dl=1"],
    }
    ...
    def process_transcript(self, root_dir, transcript_path, audio_path):
        ...
        raise ValueError(
            'No transcription found for {}'.format(transcript_path))
